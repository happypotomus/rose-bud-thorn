-- Final simplified fix - avoid make_interval and use simple interval arithmetic
...
BEGIN
  ...
  -- Use simple interval arithmetic - no make_interval
  week_start := DATE_TRUNC('day', current_time) - (days_to_subtract || ' days')::INTERVAL + INTERVAL '19 hours';
