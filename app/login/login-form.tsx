...
export function LoginForm({ redirectTo }: LoginFormProps) {
  ...
  const handleVerifyOTP = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // User is now authenticated - redirect to their destination
    ...
    <main className="flex min-h-screen flex-col items-center justify-center px-4 py-6 sm:py-8 bg-white pt-safe pb-safe">
      <div className="w-full max-w-lg sm:max-w-xl md:max-w-2xl space-y-5 sm:space-y-6">
        <div className="text-center">
          ...
          <h1 className="text-2xl sm:text-3xl font-bold mb-2 sm:mb-3 text-black px-2">Sign In</h1>
          <p className="text-gray-600 text-sm sm:text-base md:text-lg px-2">
        ...
        <div className="text-center pt-4">
          <p className="text-sm text-gray-600">
            New to Rose, Bud & Thorn?{' '}
            <a href="/invite" className="text-rose hover:text-rose-dark font-medium">
              Create your circle
            </a>
          </p>
        </div>
